...
local find_anything = 40 -- chance to find anything.
local difficulty = 30 -- 1-100 range for difficulty. The higher it is, the less likely it is that player will get a good item
