  local tasks =
{
        ...
        [7] = {questStarted = 1516, questStorage = 65006, killsRequired = 666, raceName = "Demons", rewards = {first = {enable = true, type = "exp", values = 2000000}, second = {enable = true, type = "money", values = 200000}, third = {enable = false, type = nil, values = {nil, nil}}}}
}
